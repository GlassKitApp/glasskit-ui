        ...
        <div className="mx-auto max-w-5xl px-6 py-16">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-lg text-lg leading-relaxed text-ink-2">
              ...
              the <kbd className="font-mono text-sm text-ink">arrow keys</kbd> to
              move the focus ring and{" "}
              <kbd className="font-mono text-sm text-ink">Enter</kbd> to activate
              &mdash; that&rsquo;s the Neural Band on the glasses.
            </p>
          </div>
