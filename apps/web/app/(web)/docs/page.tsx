  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <p className="mt-6 text-lg leading-relaxed text-ink-2">
        GlassKit UI is a React component library for Meta Ray-Ban Display Web
        Apps. Install the SDK, import the stylesheet once, and build inside a
        GlassViewport.
      </p>
      ...
      <p className="mt-3 text-ink-2">
        ...
        element with the <code className="font-mono text-sm">focusable</code>{" "}
        class joins D-pad navigation.
      </p>
