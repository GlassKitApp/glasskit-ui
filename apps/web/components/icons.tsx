...
export function GlassesIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <circle cx="6" cy="14" r="3.25" />
      <circle cx="18" cy="14" r="3.25" />
      <path d="M9.25 13.5c.6-1 2.15-1 2.75 0M14.75 13.5c.6-1 2.15-1 2.75 0" />
      <path d="M2.75 11 4.4 8.6a2 2 0 0 1 1.65-.85M21.25 11 19.6 8.6a2 2 0 0 0-1.65-.85" />
    </svg>
  );
}
