...
This is the same model as a [DESIGN.md](https://github.com/voltagent/awesome-design-md):
a markdown spec of a brand's colors, type, and depth that an AI agent reads to
generate matching UI. Map that spec onto the tokens below and your whole glasses
app adopts the brand.
