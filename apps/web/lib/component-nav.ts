...
export const COMPONENT_NAV: ComponentNav[] = [
  ...
  { slug: "icon", name: "Icon", category: "Display" },
  ...
  { slug: "map-view", name: "MapView", category: "Spatial" },
  ...
  { slug: "pressable", name: "Pressable", category: "Action" },
  { slug: "masonry", name: "Masonry", category: "Layout" },
  { slug: "grid", name: "Grid", category: "Layout" },
];
